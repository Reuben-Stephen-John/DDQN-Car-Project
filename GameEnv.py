...
class RacingEnv:
    ...
    def render(self, action,e):
        ...
        # Display current iteration in the center top of the screen
        iteration_text = self.font.render(f'Episode: {e}', True, pygame.Color('red'))
        text_rect = iteration_text.get_rect(center=(self.width // 2, 20))
        self.screen.blit(iteration_text, text_rect)
